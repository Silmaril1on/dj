...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f4f4f4;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #fcf5df; padding: 0 0;">
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; max-width: 600px;">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <h2 style="color: #fcb913; margin-top: 0; font-size: 24px;">Verify Your Email Address</h2>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin: 30px 0;">
                <tr>
                  <td align="center">
                    <a href="${verificationLink}" style="display: inline-block; padding: 15px 40px; background-color: #fcb913; color: #000000; text-decoration: none; font-weight: bold; font-size: 16px;">
          ...
          <tr>
            <td style="background-color: #1c1c1c; padding: 20px 30px; text-align: center;">
              ...
              <p style="color: #fcb913; font-size: 12px; margin: 0;">Discover DJs, Artists, and Book Amazing Talents</p>
            </td>
          </tr>
