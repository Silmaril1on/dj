...
const ArtistCountry = ({ artistCountry }) => {
  return (
    <FlexBox type="row-start" className="items-center text-gold">
      <CountryFlags style={{ width: '16px', height: '16px' }} countryName={artistCountry.country} />
      <FlexBox type="row-start" className='secondary text-xs gap-1 pl-1 capitalize items-center *:leading-none'>
