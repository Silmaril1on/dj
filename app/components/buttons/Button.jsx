...
const Button = ({
  ...
  if (type === "success") {
    baseBg = isBold
      ...
      : "bg-green-600/30 text-green-500  uppercase";
    overlayBg = isBold
  ...
  const baseClasses = `relative font-bold ${size === "small" ? "px-2 py-1 text-xs" : "px-4 py-1 text-base"} flex items-center justify-center 
