        ...
        <div className='h-screen w-full flex items-center justify-center'>
            <div className='relative w-96 h-96 overflow-hidden bg-gradient-to-r from-stone-950  to-black'>
                ...
                <div className='absolute w-full overflow-hidden top-0 -right-[190px] h-full bg-white '>
                    ...
                    <div className='absolute inset-0'>
                        <Image
                            ...
                            style={{
                                filter: 'drop-shadow(0 15px 15px rgba(0, 0, 0, 0.4)) drop-shadow(0 10px 5px rgba(0, 0, 0, 0.5))'
                            }}
                        />
                    </div>
                </div>
                ...
                <div className='absolute bottom-4 left-4 text-white z-10'>
                    ...
                    <p className='text-sm font-normal secondary text-gold'>Essence Radio 001</p>
                </div>
