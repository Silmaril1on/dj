  ...
  const fetchFestivalData = async (festivalId) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        dispatch(
          setError({ message: "Failed to fetch festival data", type: "error" }),
        );
      }
    } catch (error) {
      dispatch(
        setError({ message: "Error fetching festival data", type: "error" }),
      );
    } finally {
      setLoading(false);
    }
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(
          errorData.error ||
            `Failed to ${isEditMode ? "update" : "submit"} festival`,
        );
      }
          ...
          >
            {loading ? (
              ...
              <SubmissionForm
                ...
                submitButtonText={
                  isEditMode ? "Update Festival" : "Submit Festival"
                }
              />
            )}
          </FormContainer>
