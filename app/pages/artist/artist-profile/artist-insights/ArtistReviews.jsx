      ...
      return (
        ...
        >
          <ErrorCode
            ...
            description="This artist has not received any reviews yet. Be the first to leave a review!"
          />
        </SectionContainer>
      );
    }
    ...
    return (
      ...
      >
        <div className='h-full w-full flex flex-col items-center'>
          <div className="grid grid-cols-2 lg:grid-cols-3 lg:grid-rows-2 gap-3 w-full h-full">
            {data.map((item, idx) => {
              return (
                <div
                  key={idx}
                  className="border border-gold/30 p-2 bg-stone-950"
                >
          ...
          <Link href={`/artists/${artistId}/reviews`} className='hover:text-cream duration-300'>
            View all Reviews
          </Link>
        </div>
      </SectionContainer>
