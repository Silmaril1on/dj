      ...
      {!isOpen && (
        ...
        >
          ...
          <div className="bg-black/60 relative z-[2] w-full h-full p-5 backdrop-blur-xs flex justify-start">
            ...
            <span className="block lg:hidden text-lg font-medium text-chino truncate max-w-[120px]">
              {event.event_name}
            </span>
          </div>
        </motion.div>
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            animate="open"
            exit="closed"
            className="w-full h-full overflow-hidden relative flex items-end mx-1 border border-gold/30"
          >
            <Image
              src={event.event_image}
              alt={event.event_name}
            ...
            >
              ...
              <div className="p-4">
                ...
                />
                <FlexBox type="column-start" className="my-4">
                  <ArtistCountry
                ...
                <FlexBox type="row-start" className="gap-2">
                  <p className="text-chino">Doors Open: {event.doors_open}</p>
                  <Dot />
                  <p className="text-gold font-medium">{event.date}</p>
                </FlexBox>
                <Title
                  color="cream"
                  size="xs"
