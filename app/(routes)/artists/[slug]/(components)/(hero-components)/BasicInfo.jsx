  ...
  return (
    ...
    >
      {label?.map((item, idx) => (
        <h1
          key={idx}
          className={`px-4 py-1 cursor-pointer duration-300 center text-center hover:bg-chino/40 bg-cream/20 border border-cream/30 rounded-sm uppercase text-cream font-bold ${
