...
export const DATA_TYPE_CONFIGS = {
  artist: {
    ...
    api: {
      fetch: (id) => `/api/artists/${id}`,
      submit: "/api/artists/add-artist",
      update: "/api/artists/update-artist",
    },
    idParam: "artistId",
  ...
  club: {
    ...
    api: {
      fetch: (id) => `/api/club/${id}`,
      submit: "/api/club/add-club",
      update: "/api/club/add-club",
    },
    idParam: "clubId",
  ...
  festival: {
    ...
    api: {
      fetch: (id) => `/api/festivals/${id}`,
      submit: "/api/festivals/add-festival",
      update: "/api/festivals/add-festival",
    },
    idParam: "festivalId",
